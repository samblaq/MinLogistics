...
<head>
    ...
    <title>Minlogistic - Sea Freight</title>
                            ...
                            <div class="hero-cap">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="/sea">Sea Freight</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="single-services section-padding2">
                            <div class="details-img mb-40">
                                <img src="assets/img/gallery/warehouse_Min.png" alt />
                            </div>
                            <div class="details-caption">
                                <p>MLG offers a comprehensive suite of sea freight services to meet our client's shipping needs. We have extensive experience in handling all types of Cargo including oversized and heavy cargo. We undertake the following:</p>
                                <ol>
                                    <li>
                                        <p><strong>Sea freight Import & Export</strong></p>
                                        <p><strong>Full Container Load (FCL)</strong></p>
